  ...
  return (
    <>
      ...
      <nav className={`nav ${scrolled?"sc":""}`}>
        <div className="ni">
          ...
          {/* <ul className="nl">
            ...
            <li><a className="act" onClick={()=>navigate("/register")}>Register</a></li>
          </ul>

          <button className="ncta" onClick={()=>navigate("/")}>Login →</button> */}
      ...
      {/* <div className={`mob ${mobOpen?"o":""}`}>
        ...
        <a className="mcta" onClick={()=>{ setMobOpen(false); navigate("/"); }}>🔑 Go to Login</a>
      </div> */}
      ...
      <div className="stage">
        <div className={`auth-wrap ${visible?"in":""}`}>
          ...
          <p className="switch-text">
            ...
            <a className="switch-link" onClick={()=>navigate("/")}>Login</a>
          </p>
